...
const (
	KeyValueStore_GetKeyValue_FullMethodName    = "/kv.KeyValueStore/GetKeyValue"
	KeyValueStore_SetKeyValue_FullMethodName    = "/kv.KeyValueStore/SetKeyValue"
	KeyValueStore_DeleteKeyValue_FullMethodName = "/kv.KeyValueStore/DeleteKeyValue"
)
...
func (c *keyValueStoreClient) GetKeyValue(ctx context.Context, in *GetKVRequest, opts ...grpc.CallOption) (*GetKVResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetKVResponse)
	err := c.cc.Invoke(ctx, KeyValueStore_GetKeyValue_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *keyValueStoreClient) SetKeyValue(ctx context.Context, in *SetKeyValueRequest, opts ...grpc.CallOption) (*SetKeyValueResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SetKeyValueResponse)
	err := c.cc.Invoke(ctx, KeyValueStore_SetKeyValue_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedKeyValueStoreServer) GetKeyValue(context.Context, *GetKVRequest) (*GetKVResponse, error) {
...
func _KeyValueStore_GetKeyValue_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: KeyValueStore_GetKeyValue_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(KeyValueStoreServer).GetKeyValue(ctx, req.(*GetKVRequest))
	}
...
func _KeyValueStore_SetKeyValue_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: KeyValueStore_SetKeyValue_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _KeyValueStore_DeleteKeyValue_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	if interceptor == nil {
		return srv.(KeyValueStoreServer).DeleteKeyValue(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
...
var KeyValueStore_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _KeyValueStore_DeleteKeyValue_Handler,
		},
	},
